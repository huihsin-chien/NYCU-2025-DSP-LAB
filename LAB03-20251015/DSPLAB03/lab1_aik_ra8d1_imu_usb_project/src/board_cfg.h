...
#define TURN_RED_ON                               R_IOPORT_PinWrite(&g_ioport_ctrl, LED1_RED, ON); \
                                                  R_IOPORT_PinWrite(&g_ioport_ctrl, LED1_GREEN, OFF);\
                                                  R_IOPORT_PinWrite(&g_ioport_ctrl, LED1_BLUE, OFF);
...
#define KIT_NAME_MACRO                            "EK-RA8D1"
