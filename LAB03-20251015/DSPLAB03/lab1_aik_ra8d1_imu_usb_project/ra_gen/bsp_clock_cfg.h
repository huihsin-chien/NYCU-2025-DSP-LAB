...
#define BSP_CFG_PLL_MUL BSP_CLOCKS_PLL_MUL(80,0) /* PLL Mul x80-99|Mul x80|PLL Mul x80.00 */
...
#define BSP_CFG_PLODIVR (BSP_CLOCKS_PLL_DIV_9) /* PLL1R Div /9 */
#define BSP_CFG_PLL1R_FREQUENCY_HZ (106666666) /* PLL1R 106666666Hz */
...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(80,0) /* PLL2 Mul x80-99|Mul x80|PLL2 Mul x80.00 */
...
#define BSP_CFG_SCICLK_DIV (BSP_CLOCKS_SCI_CLOCK_DIV_2) /* SCICLK Div /2 */
